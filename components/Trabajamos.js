...
const Trabajamos = () => {
  return (
    ...
    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold">Como trabajamos</h2>
    <p className="text-balance text-sm sm:text-base md:text-lg">En nuestro catálogo, los cortes están disponibles en cuatro niveles de calidad: 120, 125, 130 y 107.</p>
